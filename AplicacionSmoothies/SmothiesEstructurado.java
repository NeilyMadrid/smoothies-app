...
/**
 * Write a description of class SmothiesEstructurado here.
 * 
 * @author (your name) 
...
public class SmothiesEstructurado
{
    // instance variables - replace the example below with your own
    public static void main(String[] args){
        Scanner sc = new Scanner(System.in);
        
        String vAzucar[] = new String[1000];
	String vBase[] = new String[1000];
	String vCodigo[] = new String[1000];
	String vNombre[] = new String[1000];
    ...
    for(i=0; i<cantidad; i++){
        ...
        switch(codigo){
            ...
            totalFresaArandanos = totalFresaArandanos + vPrecio[i]; // suma el precio que lleva mas la nueva venta
            break;
           
            case"2":
            contadorPinaNaranja++; // suma cada sabor
            totalPinaNaranja = totalPinaNaranja + vPrecio[i]; // suma el precio que lleva mas la nueva venta
            break;
            
            case"3":
            contadorMangoUchuva++; // suma cada sabor
            totalMangoUchuva = totalMangoUchuva + vPrecio[i]; // suma el precio que lleva mas la nueva venta
            break;
            
            case"4":
            contadorSandiaLimon++; // suma cada sabor
            totalSandiaLimon = totalSandiaLimon + vPrecio[i]; // suma el precio que lleva mas la nueva venta
            break;
            
            case"5":
            contadorBananoPapaya++; // suma cada sabor
            totalBananoPapaya = totalBananoPapaya + vPrecio[i]; // suma el precio que lleva mas la nueva venta
            break;
        }
